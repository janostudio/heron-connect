...
func printConfigUsage() {
	fmt.Fprintf(os.Stderr, `Usage: heron-connect config <subcommand>
...
Examples:
  heron-connect config example              Print example config
  heron-connect config example > config.toml  Save example config
  heron-connect config format               Format default config file
  heron-connect config fmt --config /path/to/config.toml
`)
}
