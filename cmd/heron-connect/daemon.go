...
func daemonInstall(args []string) {
	...
	fmt.Println("heron-connect daemon installed and started.")
	fmt.Println()
	...
	fmt.Println("  heron-connect daemon status    - Check status")
	fmt.Println("  heron-connect daemon logs -f   - Follow logs")
	fmt.Println("  heron-connect daemon restart   - Restart")
	fmt.Println("  heron-connect daemon stop      - Stop")
...
func daemonUninstall() {
	...
	daemon.RemoveMeta()
	fmt.Println("heron-connect daemon uninstalled.")
}
...
func daemonStart() {
	...
	fmt.Println("heron-connect daemon started.")
}
...
func daemonStop() {
	...
	fmt.Println("heron-connect daemon stopped.")
}
...
func daemonRestart(args []string) {
	...
	fmt.Println("heron-connect daemon restarted.")
}
...
func requireInstalled(mgr daemon.Manager) {
	...
	if st == nil || !st.Installed {
		...
		fmt.Fprintln(os.Stderr, "  heron-connect daemon install --work-dir /path/to/config-dir")
		os.Exit(1)
	}
}
...
func daemonStatus() {
	...
	fmt.Println("heron-connect daemon status")
	fmt.Println()
	...
	if !st.Installed {
		...
		fmt.Printf("  Platform:  %s\n", st.Platform)
		fmt.Println()
		fmt.Println("  Run: heron-connect daemon install")
		return
	}
...
func printDaemonUsage() {
	fmt.Println(`Usage: heron-connect daemon <command> [flags]
