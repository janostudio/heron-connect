...
func resolveSocketPath(dataDir string) string {
	...
	if home, err := os.UserHomeDir(); err == nil {
		return filepath.Join(home, ".heron-connect", "run", "api.sock")
	}
	return filepath.Join(".heron-connect", "run", "api.sock")
}

func printSendUsage() {
	fmt.Println(`Usage: heron-connect send [options] <message>
       heron-connect send [options] -m <message>
       heron-connect send [options] --stdin < file
       heron-connect send [options] --image <path>
       heron-connect send [options] --file <path>
       echo "msg" | heron-connect send [options] --stdin

Send a message or attachment to an active heron-connect session.
...
Examples:
  heron-connect send "Daily summary: ..."
  heron-connect send -m "Build completed successfully"
  heron-connect send --message "Chart generated" --image /tmp/chart.png
