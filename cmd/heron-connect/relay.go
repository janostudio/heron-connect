...
func printRelayUsage() {
	fmt.Println(`Usage: heron-connect relay <command> [options]

Commands:
  send      Send a message to another bot via relay

Run 'heron-connect relay <command> --help' for details.`)
}

func printRelaySendUsage() {
	fmt.Println(`Usage: heron-connect relay send [options] [<target_project> <message>]
...
Examples:
  heron-connect relay send --to claude-bot "What's the weather today?"
  heron-connect relay send claude-bot What is the weather today`)
}
