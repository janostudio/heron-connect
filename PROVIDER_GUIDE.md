# Heron Connect: Custom Models & Providers Architecture

## Overview

Heron Connect supports **runtime provider/model switching** through a flexible system that allows:
...
When heron-connect starts a project:
