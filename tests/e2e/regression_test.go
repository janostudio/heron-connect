...
// Package e2e contains smoke and regression tests for heron-connect.
...
import (
	...
	"github.com/janostudio/heron-connect/tests/mocks"
	"github.com/janostudio/heron-connect/tests/mocks/fake"
...
func TestRegression_DiscordEmbed(t *testing.T) {
	...
	embed.Footer.Text = "heron-connect v1.0"
	...
	assert.Equal(t, "heron-connect v1.0", embed.Footer.Text)
