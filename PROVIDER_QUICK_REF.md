# Heron Connect Provider/Model — Quick Reference
...
heron-connect provider add --name relay --api-key sk-... --base-url https://...

# CLI: List providers
heron-connect provider list --project my-project

# CLI: Delete provider
heron-connect provider delete --name relay
```
